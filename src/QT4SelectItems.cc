...
// *****************************************************************************
void QT4SelectItems::okClicked() {

  for( int i = 0 , is = list_widget_->count() ; i < is ; ++i )
    (*selected_items_)[i] =
      list_widget_->isItemSelected( list_widget_->item( i ) );
...
// *****************************************************************************
void QT4SelectItems::cancelClicked() {

  fill( selected_items_->begin() , selected_items_->end() , 0 );
  reject();
